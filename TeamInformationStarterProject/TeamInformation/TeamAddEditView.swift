...
struct TeamAddEditView: View {
    ...
    @Environment(Team.self) var teams
   // @Binding var teams: Teams
    ...
    func addTeam(){
        let newTeam = Team(cohortNumber: cohortNumber, teamNumber: teamNumber, studentName: studentName, studentAdmissionNumber: studentAdmissionNumber, isStudentCSECore: isStudentCSECore, appName: appName, appDescription: appDescription, appMilestoneCompletionDate: appMilestoneCompletionDate)
